import { AddCircle, AddCircleOutline, RemoveCircle, Circle, Help  } from "@mui/icons-material";
import { red, green, blueGrey } from "@mui/material/colors";

export default function EvidenceTableEffectiveness(props: { effectiveness: string }) {
  ...
  const component = function(ef: string) {
    switch(ef) {
      ...
      case '効果なし':
        return (
          <svg style={{width:'1.7em', height:'1.7em', fill:'#e57373'}} width="256px" height="256px" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg">
      ...
      case 'ミックス':
        return (
          <svg version="1.1" id="layer_2" style={{width:'1.7em', height:'1.7em', fill:'#757575'}} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 256 256">
            <path id="frame" d="M128,24C70.7,24,24,70.7,24,128s46.7,104,104,104s104-46.7,104-104S185.3,24,128,24z M118.8,212.9
              ...
              />
            <polygon id="plus" points="183.9,121.8 183.9,99.6 171.1,99.6 171.1,121.8 150.1,121.8 150.1,134.2 171.1,134.2 171.1,156.4 
