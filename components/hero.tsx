		...
		<div className="hero top-image">
			<Container sx={{ m: "auto" }}>
				...
				<Typography component="p" variant="body1" className="lead">
					過去の研究成果を確認して、証拠に基づく政策（Evidence Based Policy
					Making,
					EBPM）を進めましょう。気になった政策分野のタブをクリックすれば、世界中の研究者が実施した実験や研究成果が確認できます。
				</Typography>
			</Container>
		</div>
	);
		...
		<div className="hero howto-image">
			<Container sx={{ m: "auto" }}>
				...
				<Typography component="p" variant="body1" className="lead">
					...
					を示しています。さまざまな課題に対する政策のアイデアや、客観的なデータに基づく政策の優先づけ、議会や住民とのコンセンサスづくりなどにご活用できます。
				</Typography>
				<Typography component="p" variant="body1" className="lead">
				...
				<Typography component="p" variant="body1" className="lead">
					GitHubから新たな記事（レビュー）を自由に投稿することができます。新たな政策課題も大歓迎です。重要な研究やご自身の研究成果を簡単なレビューにして政策担当者に届けましょう。詳細は
					<a href="https://github.com/CyberAgentAILab/EBPMDB/">GitHubページ</a>
					をご覧ください。
				</Typography>
			</Container>
		</div>
